...
describe("object properties", function () {
  test("should work if the generator is a simple object property", function () {
    var obj = {
      gen: function (x) {
  ...
  test("should work if the generator is a shorthand object method", function () {
    var obj = {
      *gen(x) {
        yield x;
      }
  ...
  test("should work if the generator is a shorthand computed object method", function () {
    var fnName = "gen";
    var obj = {
      *[fnName](x) {
        yield x;
